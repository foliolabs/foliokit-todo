...
if ( !class_exists('Puc_Todo_UpdateChecker', false) ):

	abstract class Puc_Todo_UpdateChecker {
		...
		/**
		 * @var Puc_Todo_Scheduler
		 */
		public $scheduler;

		/**
		 * @var Puc_Todo_UpgraderStatus
		 */
		protected $upgraderStatus;

		/**
		 * @var Puc_Todo_StateStore
		 */
		...
		public function __construct($metadataUrl, $directoryName, $slug = null, $checkPeriod = 12, $optionName = '') {
			...
			$this->upgraderStatus = new Puc_Todo_UpgraderStatus();
			$this->updateState = new Puc_Todo_StateStore($this->optionName);
		 ...
		 *
		 * @return Puc_Todo_Update An instance of Update, or NULL when no updates are available.
		 */
		 ...
		 * @return array [Puc_Todo_Metadata|null, array|WP_Error] A metadata instance and the value returned by wp_remote_get().
		 */
		...
		protected function createDebugBarExtension() {
			return new Puc_Todo_DebugBar_Extension($this);
		}

		/**
		 * Display additional configuration details in the Debug Bar panel.
		 *
		 * @param Puc_Todo_DebugBar_Panel $panel
		 */

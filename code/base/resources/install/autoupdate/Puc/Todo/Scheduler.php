<?php
if ( !class_exists('Puc_Todo_Scheduler', false) ):

	/**
	 * The scheduler decides when and how often to check for updates.
	 * It calls @see Puc_Todo_UpdateChecker::checkForUpdates() to perform the actual checks.
	 */
	class Puc_Todo_Scheduler {
		 ...
		 *
		 * @param Puc_Todo_UpdateChecker $updateChecker
